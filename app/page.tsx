...
export default function Home() {
  return (
    <main className='w-screen h-screen relative1'>
      <div className='flex items-center w-full h-full bg-cover bg-center ' style={{background: "url(/main-bg.webp)"}}>
        <div className='pl-20 md:pl-40 pb-56  md:pb20 flex flex-col gap-5 z-[10] max-w-[750px]'>
          ...
          <p className='text-gray-200 hidden md:block'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel quo eum porro saepe repudiandae ratione aut, vero expedita. Sit, ea.
          </p>

          <div className='flex-col md:flex-row hidden gap-5 md:flex'>
      ...
      <div className='absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5'>
            ...
            <Link href="/my-projects" className='rounded-[20px] group bg-transparen border border-white  hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]'>
              
            MyProjects
            </Link>

            <Link href="/contact-me" className='rounded-[20px] group bg-transparen border border-white  hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]'> 
            Contact Me
            </Link>
          </div>
